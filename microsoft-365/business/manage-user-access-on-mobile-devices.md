...
|Nie zezwalaj użytkownikom na kopiowanie zawartości z aplikacji pakietu Office do aplikacji osobistych  <br/> |Gdy ustawienie to **Włączone,** użytkownik nie może skopiować informacji w pliku służbowym do pliku osobistego. Jeśli ustawienie jest **wyłączone,** użytkownik może skopiować informacje z pliku służbowego do aplikacji osobistej lub konta osobistego.  <br/> |
