...
1. Zaloguj się do [centrum administracyjnego](https://aka.ms/bcsportal) za pomocą poświadczeń administratora globalnego. 
    
2. W centrum administracyjnym na karcie **Akcje urządzenia** wybierz pozycję **Resetowanie do ustawień fabrycznych**.
    
    ![On the Device actions card, choose Factory reset](media/7caddd12-207e-4c99-b61c-0495fc5f55e3.png)
  
3. W okienku **Resetowanie do ustawień fabrycznych** zaznacz pole wyboru obok urządzenia, z którego chcesz usunąć dane, a następnie kliknij pozycję **Wybierz**.
